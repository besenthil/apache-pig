...
-- declare variables
%declare source_file_path '/user/data';
...
-- Store the bad records in a separate file
STORE bad_records_with_country_is_null INTO '$source_file_path/BAD_RECORDS.CSV';
