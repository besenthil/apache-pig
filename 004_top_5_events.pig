...
-- Tokenize the URL
tokenized_underscore = FOREACH source_events generate GLOBALEVENTID, SOURCEURL,FLATTEN(STRSPLIT(SOURCEURL,'-',10000)) as word;

-- Tokenize the URL
tokenized_slash = FOREACH tokenized_underscore generate GLOBALEVENTID, SOURCEURL,FLATTEN(STRSPLIT(word,'/',10000)) as word;
